...
namespace All_Star_Cricket_Game_1
{
    class MainClass
    {
        ...
        public static void PickAndCreateTeams()
        {
            ...
            //choosing teams
            Console.WriteLine("Welcome to the survival T" + limitedOverVariation +" game between India and New Zealand. It's your team versus the computer's. " +
