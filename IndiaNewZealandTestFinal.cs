...
namespace All_Star_Cricket_Game_1
{
    class MainClass
    {
        ...
        /* General note: At some point, need to go back and allow player/computer to declare*/
        /* won by 10 wickets. scorecard not showing up. FIX THIS!*/
        ...
        public static string followOrNah;
        ...
        public static void PickAndCreateTeams()
        {
            ...
            while (pickedASide == false)
            {
                if (sidePicked == "New Zealand")
                {
                    ...
                    Console.WriteLine("------------");
                    Console.WriteLine("            ");
                    Console.WriteLine("You have chosen New Zealand");
                    Console.WriteLine("            ");
                    Console.Write("Press Enter to continue!");
                    Console.ReadLine();
                ...
                else if (sidePicked == "India")
                {
                    ...
                    Console.WriteLine("------------");
                    Console.WriteLine("            ");
                    Console.WriteLine("You have chosen India");
                    Console.WriteLine("            ");
                    Console.Write("Press Enter to continue!");
                    Console.ReadLine();
                    Console.WriteLine("------------");
        ...
        public static void LetTheGamesBegin()
        {
            if (waitWhoBatting == 1 || waitWhoBatting == 4)
            {
                ...
                if(lead >= 0)
                {
                    ...
                    while(proceed == false)
                    {
                        Console.WriteLine("You now have two options: bat again or send in the opposition " +
                        " to follow on. What would you prefer? Enter 'bat' for batting again and 'follow-on' " +
                        " if you would like to send the opposition in for their second inning. ");
                        followOrNah = Console.ReadLine(); //make sure input is either bat or follow-on
                        if(followOrNah == "bat" || followOrNah == "follow-on")
                        {
                            proceed = true;
                            Console.WriteLine("Spelling error. Please enter input again.");
                        }
                    }

                    if (followOrNah == "bat")
                    {
                        //usual game continues
                    ...
                    else if(followOrNah == "follow-on")
                    {
                        //computer bats again. You chase. input is whatever computer is trailing by. So lead.
                        playerBowlerRuns.Clear();
                        playerBowlerWickets.Clear();
                        playerBowlerOvers.Clear();
                        //Console.WriteLine("HELLO10");
                        ...
                        if(secondInningTotalW + thirdInningTotalW >= firstInningTotalW)
                        {
                            //player chases. Input is whatever lead the computer got.
                            computerBowlerRuns.Clear();
                            computerBowlerWickets.Clear();
                            computerBowlerOvers.Clear();
                            //Console.WriteLine("HELLO8");
                            ...
                            FourthInningPlayerTeamBats(secondInningTotalW + thirdInningTotalW - firstInningTotalW);
                        }
                        else if(secondInningTotalW + thirdInningTotalW < firstInningTotalW)
                        {
                            Console.WriteLine("You have won by an inning and " +
                                (firstInningTotalW - secondInningTotalW - thirdInningTotalW) + " runs.");
                        }
                    }
                }
            ...
            if (waitWhoBatting == 2 || waitWhoBatting == 3)
            {
                ...
                if(lead >= 0)
                {
                    //your team is leading. Computer bats, obviously. Business as usual.
                ...
                {
                    //your team is trailing.
                    Random r2 = new Random();
                    int compPicks = r2.Next(0, 2);

                    if(compPicks == 0)
                    {
                        //business as usual. comp bats again.
                        Console.WriteLine("The opposition has decided to bat again. Their lead is" +
                            " currently " + (-lead) + " runs.");
                        playerBowlerRuns.Clear();
                        playerBowlerWickets.Clear();
                        playerBowlerOvers.Clear();
                    ...
                    {
                        //comp enforces follow on. player bats 3rd. comp bats fourth.
                        Console.WriteLine("The opposition has decided to enforce follow-on. You currently trail by " +
                            + (-lead) + " runs.");
                        ...
                        if(secondInningTotalW + thirdInningTotalW <= firstInningTotalW)
                        {
                            Console.WriteLine("You've lost. " + sideNotPicked + " has won by" +
                                " an innning and " + (firstInningTotalW  - secondInningTotalW - thirdInningTotalW) + " runs.");
                        }
                        else if(secondInningTotalW + thirdInningTotalW > firstInningTotalW)
                        {
                            playerBowlerRuns.Clear();
                            ...
                            FourthInningComputerTeamBats(secondInningTotalW + thirdInningTotalW - firstInningTotalW);
                        }
                    }
                }
            }
        ...
        public static int FourthInningPlayerTeamBats(int input)
        {
            ...
            else if (chasingWicketLost == 0)
            {
                Console.WriteLine("HEHEHAHAHOHO");
            }
