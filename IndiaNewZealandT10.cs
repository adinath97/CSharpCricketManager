...
namespace All_Star_Cricket_Game_1
{
    class MainClass
    {
        ...
        public static int FirstInningsplayerTeamBats()
        {
            ...
            while (firstInningsComplete == false)
            {
                ...
                while (numberOfBalls < 6 && firstInningsComplete == false && !(numberOfOvers == 10))
                {
                    ...
                    int bowlingScore = rbowlingScore.Next(0, 14);
                ...
                while (numberOfBalls < 6 && firstInningsComplete == false && !(numberOfOvers == 10))
                {
                    ...
                    Random rbowlingScore = new Random();
                    int bowlingScore = rbowlingScore.Next(0, 18);
        ...
        public static int SecondInningscomputerTeamBats(int input)
        {
                ...
                if (gameHasBegun == false)
                {
                    ...
                    if (bowlerNumber == 1 && playerBowler1Overs < 2)
                    {
                        ...
                        if (secondInningsComplete == false && !(numberOfOvers == 10))
                        {
                            ...
                            Console.WriteLine("          ");
                            Console.WriteLine(" Current run-rate: " + (secondInningsTotal / numberOfOvers));
                            Console.WriteLine("          ");
                            Console.WriteLine(" Required run-rate: " + ((firstInningsTotal + 1 - secondInningsTotal) /
                                (10 - numberOfOvers)));
                            Console.WriteLine("-----------");
            ...
            //delete this once ur done setting up ^:
            bool hahaNoWay = false;

            if (hahaNoWay == true)
            {
                while ((secondInningsComplete == false && gameOver == false) || !(numberOfOvers == 10))
                {
                    //player bowler #1
        ...
        public static int FirstInningscomputerTeamBats()
        {
            ...
            while (numberBatsmenPrinted < battingWicketsLost)
            {
                ...
                index += 1;
                numberBatsmenPrinted += 1;
                if (numberBatsmenPrinted == battingWicketsLost)
                {
        ...
        public static int SecondInningsplayerTeamBats(int input)
            {
                ...
                if (!(secondInningsTotal > input) && battingWicketsLost < 10)
                {
                    whoopie1 = 0;
                    whoopie2 = 0;
                    whoopie3 = 0;
                ...
                float runrate = firstInningsTotal / overs;
